...
curl -XPUT "http://$ESDBHOST:9200/sibdataportal/_mapping/occurrence" -d '
{
  "occurrence": {
    "properties": {
      ...
      "country_name_english_interpreted": {
        "type": "string",
        "index": "analyzed",
        "fields" : {
          "untouched": {
      ...
      "country_name_spanish_interpreted": {
        "type": "string",
        "index": "analyzed",
        "fields" : {
          "untouched": {
